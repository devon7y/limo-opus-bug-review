...
A **333-agent Opus 4.8** multi-agent workflow reviewed the current stable release `v4.2.1` (synced with `origin/v4.2.1`): 56 finder passes plus 5 cross-cutting systemic finders, then every candidate was re-checked by an independent adversarial verifier that had to construct a concrete failing input against the real code or reject it (~12.3M tokens).

**218 deduplicated confirmed defects** — 4 critical · 64 high · 92 medium · 58 low (202 CONFIRMED, 16 PLAUSIBLE) across 84 files.

Findings are deduplicated (dual-lens + cross-cutting overlaps merged by file & line) and ranked by severity, then verdict. `external/` (FieldTrip, PSOM, apcluster) and `deprecated/` were out of scope. Line numbers reference the v4.2.1 working tree. Fixes are minimal suggestions.

| Severity | Count | Verdicts |
|---|---:|---|
| 🔴 Critical | 4 | 4 CONFIRMED |
| 🟠 High | 64 | 64 CONFIRMED |
| 🟡 Medium | 92 | 92 CONFIRMED |
| ⚪ Low | 58 | 42 CONFIRMED, 16 PLAUSIBLE |
...
#### 14. `limo_check_neighbourghs.m:36` — 🟠 HIGH · CONFIRMED
...
#### 15. `limo_check_weight.m:404` — 🟠 HIGH · CONFIRMED
...
#### 16. `limo_combine_components.m:49` — 🟠 HIGH · CONFIRMED
...
#### 17. `limo_combine_components.m:60` — 🟠 HIGH · CONFIRMED
...
#### 18. `limo_concatcells.m:37` — 🟠 HIGH · CONFIRMED
...
#### 19. `limo_contrast.m:231` — 🟠 HIGH · CONFIRMED
...
#### 20. `limo_contrast.m:298` — 🟠 HIGH · CONFIRMED
...
#### 21. `limo_contrast.m:416` — 🟠 HIGH · CONFIRMED
...
#### 22. `limo_contrast.m:510` — 🟠 HIGH · CONFIRMED
...
#### 23. `limo_contrast.m:631` — 🟠 HIGH · CONFIRMED
...
#### 24. `limo_contrast_sessions.m:117` — 🟠 HIGH · CONFIRMED
...
#### 25. `limo_create_single_trials_gui.m:160` — 🟠 HIGH · CONFIRMED
...
#### 26. `limo_design_matrix_tf.m:303` — 🟠 HIGH · CONFIRMED
...
#### 27. `limo_display_results.m:1598` — 🟠 HIGH · CONFIRMED
...
#### 28. `limo_eeg.m:158` — 🟠 HIGH · CONFIRMED
...
#### 29. `limo_eeg.m:516` — 🟠 HIGH · CONFIRMED
...
#### 30. `limo_eeg_tf.m:351` — 🟠 HIGH · CONFIRMED
...
#### 31. `limo_eeg_tf.m:425` — 🟠 HIGH · CONFIRMED
...
#### 32. `limo_eeg_tf.m:497` — 🟠 HIGH · CONFIRMED
...
#### 33. `limo_get_effect_size.m:218` — 🟠 HIGH · CONFIRMED
...
#### 34. `limo_get_files.m:47` — 🟠 HIGH · CONFIRMED
...
#### 35. `limo_get_model_data.m:17` — 🟠 HIGH · CONFIRMED
...
#### 36. `limo_glm.m:750` — 🟠 HIGH · CONFIRMED
...
#### 37. `limo_glm.m:883` — 🟠 HIGH · CONFIRMED
...
#### 38. `limo_glm.m:1110` — 🟠 HIGH · CONFIRMED
...
#### 39. `limo_glm.m:1152` — 🟠 HIGH · CONFIRMED
...
#### 40. `limo_glm_boot.m:238` — 🟠 HIGH · CONFIRMED
...
#### 41. `limo_glm_handling.m:717` — 🟠 HIGH · CONFIRMED
...
#### 42. `limo_itc.m:207` — 🟠 HIGH · CONFIRMED
...
#### 43. `limo_itc.m:312` — 🟠 HIGH · CONFIRMED
...
#### 44. `limo_itc_import_data.m:36` — 🟠 HIGH · CONFIRMED
...
#### 45. `limo_lateralization.m:110` — 🟠 HIGH · CONFIRMED
...
#### 46. `limo_mglm.m:270` — 🟠 HIGH · CONFIRMED
...
#### 47. `limo_mglm.m:502` — 🟠 HIGH · CONFIRMED
...
#### 48. `limo_mglm.m:895` — 🟠 HIGH · CONFIRMED
...
#### 49. `limo_mstat_values.m:214` — 🟠 HIGH · CONFIRMED
...
#### 50. `limo_power_spec_from_erp.m:40` — 🟠 HIGH · CONFIRMED
...
#### 51. `limo_random_robust.m:708` — 🟠 HIGH · CONFIRMED
...
#### 52. `limo_random_robust.m:1342` — 🟠 HIGH · CONFIRMED
...
#### 53. `limo_rep_anova.m:229` — 🟠 HIGH · CONFIRMED
...
#### 54. `limo_results.m:312` — 🟠 HIGH · CONFIRMED
...
#### 55. `limo_results.m:315` — 🟠 HIGH · CONFIRMED
...
#### 56. `limo_robust_ci.m:45` — 🟠 HIGH · CONFIRMED
...
#### 57. `limo_robust_ci.m:49` — 🟠 HIGH · CONFIRMED
...
#### 58. `limo_robust_rep_anova.m:103` — 🟠 HIGH · CONFIRMED
...
#### 59. `limo_robust_rep_anova.m:124` — 🟠 HIGH · CONFIRMED
...
#### 60. `limo_semi_partial_coef.m:100` — 🟠 HIGH · CONFIRMED
...
#### 61. `limo_semi_partial_coef.m:213` — 🟠 HIGH · CONFIRMED
...
#### 62. `limo_semi_partial_coef.m:280` — 🟠 HIGH · CONFIRMED
...
#### 63. `limo_stat_values.m:201` — 🟠 HIGH · CONFIRMED
...
#### 64. `limo_tfce.m:720` — 🟠 HIGH · CONFIRMED
...
#### 65. `limo_tfce_handling.m:289` — 🟠 HIGH · CONFIRMED
...
#### 66. `limo_trimmed_mean.m:103` — 🟠 HIGH · CONFIRMED
...
#### 67. `limo_trimmed_mean.m:112` — 🟠 HIGH · CONFIRMED
...
#### 68. `np_spectral_clustering.m:197` — 🟠 HIGH · CONFIRMED
...
#### 69. `limo_BrownForsythe.m:43` — 🟡 MEDIUM · CONFIRMED
...
#### 70. `limo_LI.m:197` — 🟡 MEDIUM · CONFIRMED
...
#### 71. `limo_LI.m:294` — 🟡 MEDIUM · CONFIRMED
...
#### 72. `limo_STAPLE.m:134` — 🟡 MEDIUM · CONFIRMED
...
#### 73. `limo_batch.m:362` — 🟡 MEDIUM · CONFIRMED
...
#### 74. `limo_batch.m:409` — 🟡 MEDIUM · CONFIRMED
...
#### 75. `limo_batch.m:471` — 🟡 MEDIUM · CONFIRMED
...
#### 76. `limo_batch_design_matrix.m:150` — 🟡 MEDIUM · CONFIRMED
...
#### 77. `limo_batch_design_matrix.m:289` — 🟡 MEDIUM · CONFIRMED
...
#### 78. `limo_boot_threshold.m:19` — 🟡 MEDIUM · CONFIRMED
...
#### 79. `limo_bootttest1.m:121` — 🟡 MEDIUM · CONFIRMED
...
#### 80. `limo_central_tendency_and_ci.m:789` — 🟡 MEDIUM · CONFIRMED
...
#### 81. `limo_central_tendency_and_ci.m:1069` — 🟡 MEDIUM · CONFIRMED
...
#### 82. `limo_chancluster_test.m:1` — 🟡 MEDIUM · CONFIRMED
...
#### 83. `limo_chancluster_test.m:34` — 🟡 MEDIUM · CONFIRMED
...
#### 84. `limo_cluster_attributes.m:55` — 🟡 MEDIUM · CONFIRMED
...
#### 85. `limo_clusterica.m:138` — 🟡 MEDIUM · CONFIRMED
...
#### 86. `limo_combine_catvalues.m:63` — 🟡 MEDIUM · CONFIRMED
...
#### 87. `limo_combine_components.m:59` — 🟡 MEDIUM · CONFIRMED
...
#### 88. `limo_compute_H0.m:38` — 🟡 MEDIUM · CONFIRMED
...
#### 89. `limo_contrast.m:417` — 🟡 MEDIUM · CONFIRMED
...
#### 90. `limo_contrast.m:571` — 🟡 MEDIUM · CONFIRMED
...
#### 91. `limo_contrast.m:630` — 🟡 MEDIUM · CONFIRMED
...
#### 92. `limo_contrast.m:769` — 🟡 MEDIUM · CONFIRMED
...
#### 93. `limo_contrast_execute.m:118` — 🟡 MEDIUM · CONFIRMED
...
#### 94. `limo_contrast_sessions.m:149` — 🟡 MEDIUM · CONFIRMED
...
#### 95. `limo_create_files.m:36` — 🟡 MEDIUM · CONFIRMED
...
#### 96. `limo_create_single_trials_gui.m:89` — 🟡 MEDIUM · CONFIRMED
...
#### 97. `limo_display_results.m:409` — 🟡 MEDIUM · CONFIRMED
...
#### 98. `limo_display_results.m:1414` — 🟡 MEDIUM · CONFIRMED
...
#### 99. `limo_display_results.m:1803` — 🟡 MEDIUM · CONFIRMED
...
#### 100. `limo_display_results.m:1961` — 🟡 MEDIUM · CONFIRMED
...
#### 101. `limo_ecluster_make.m:89` — 🟡 MEDIUM · CONFIRMED
...
#### 102. `limo_ecluster_test.m:91` — 🟡 MEDIUM · CONFIRMED
...
#### 103. `limo_eeg.m:502` — 🟡 MEDIUM · CONFIRMED
...
#### 104. `limo_eeg.m:577` — 🟡 MEDIUM · CONFIRMED
...
#### 105. `limo_eeg.m:792` — 🟡 MEDIUM · CONFIRMED
...
#### 106. `limo_eeg_tf.m:287` — 🟡 MEDIUM · CONFIRMED
...
#### 107. `limo_eeg_tf.m:449` — 🟡 MEDIUM · CONFIRMED
...
#### 108. `limo_eeg_tf.m:517` — 🟡 MEDIUM · CONFIRMED
...
#### 109. `limo_expected_chanlocs.m:260` — 🟡 MEDIUM · CONFIRMED
...
#### 110. `limo_get_anova_files.m:31` — 🟡 MEDIUM · CONFIRMED
...
#### 111. `limo_get_effect_size.m:147` — 🟡 MEDIUM · CONFIRMED
...
#### 112. `limo_get_effect_size.m:264` — 🟡 MEDIUM · CONFIRMED
...
#### 113. `limo_get_model_data.m:39` — 🟡 MEDIUM · CONFIRMED
...
#### 114. `limo_glm.m:285` — 🟡 MEDIUM · CONFIRMED
...
#### 115. `limo_glm.m:876` — 🟡 MEDIUM · CONFIRMED
...
#### 116. `limo_glm_boot.m:748` — 🟡 MEDIUM · CONFIRMED
...
#### 117. `limo_glm_handling.m:820` — 🟡 MEDIUM · CONFIRMED
...
#### 118. `limo_glm_null.m:24` — 🟡 MEDIUM · CONFIRMED
...
#### 119. `limo_harrell_davis.m:80` — 🟡 MEDIUM · CONFIRMED
...
#### 120. `limo_itc.m:448` — 🟡 MEDIUM · CONFIRMED
...
#### 121. `limo_itc_gui.m:311` — 🟡 MEDIUM · CONFIRMED
...
#### 122. `limo_itc_import_data.m:130` — 🟡 MEDIUM · CONFIRMED
...
#### 123. `limo_itc_import_data.m:143` — 🟡 MEDIUM · CONFIRMED
...
#### 124. `limo_mglm.m:157` — 🟡 MEDIUM · CONFIRMED
...
#### 125. `limo_mglm.m:618` — 🟡 MEDIUM · CONFIRMED
...
#### 126. `limo_mglm.m:841` — 🟡 MEDIUM · CONFIRMED
...
#### 127. `limo_mglm.m:884` — 🟡 MEDIUM · CONFIRMED
...
#### 128. `limo_mstat_values.m:89` — 🟡 MEDIUM · CONFIRMED
...
#### 129. `limo_pair_channels.m:89` — 🟡 MEDIUM · CONFIRMED
...
#### 130. `limo_path_update.m:62` — 🟡 MEDIUM · CONFIRMED
...
#### 131. `limo_path_update.m:160` — 🟡 MEDIUM · CONFIRMED
...
#### 132. `limo_plot_difference.m:374` — 🟡 MEDIUM · CONFIRMED
...
#### 133. `limo_plots.m:131` — 🟡 MEDIUM · CONFIRMED
...
#### 134. `limo_plots.m:132` — 🟡 MEDIUM · CONFIRMED
...
#### 135. `limo_prederror.m:45` — 🟡 MEDIUM · CONFIRMED
...
#### 136. `limo_random_robust.m:157` — 🟡 MEDIUM · CONFIRMED
...
#### 137. `limo_random_robust.m:351` — 🟡 MEDIUM · CONFIRMED
...
#### 138. `limo_random_robust.m:477` — 🟡 MEDIUM · CONFIRMED
...
#### 139. `limo_random_robust.m:604` — 🟡 MEDIUM · CONFIRMED
...
#### 140. `limo_random_robust.m:687` — 🟡 MEDIUM · CONFIRMED
...
#### 141. `limo_random_select.m:300` — 🟡 MEDIUM · CONFIRMED
...
#### 142. `limo_random_select.m:316` — 🟡 MEDIUM · CONFIRMED
...
#### 143. `limo_random_select.m:1044` — 🟡 MEDIUM · CONFIRMED
...
#### 144. `limo_random_select.m:1099` — 🟡 MEDIUM · CONFIRMED
...
#### 145. `limo_random_select.m:1236` — 🟡 MEDIUM · CONFIRMED
...
#### 146. `limo_random_select.m:1466` — 🟡 MEDIUM · CONFIRMED
...
#### 147. `limo_random_select.m:1566` — 🟡 MEDIUM · CONFIRMED
...
#### 148. `limo_random_select.m:1843` — 🟡 MEDIUM · CONFIRMED
...
#### 149. `limo_robust_rep_anova.m:79` — 🟡 MEDIUM · CONFIRMED
...
#### 150. `limo_robust_rep_anova.m:107` — 🟡 MEDIUM · CONFIRMED
...
#### 151. `limo_stat_values.m:135` — 🟡 MEDIUM · CONFIRMED
...
#### 152. `limo_stat_values.m:456` — 🟡 MEDIUM · CONFIRMED
...
#### 153. `limo_stat_values.m:503` — 🟡 MEDIUM · CONFIRMED
...
#### 154. `limo_stat_values.m:510` — 🟡 MEDIUM · CONFIRMED
...
#### 155. `limo_tfce_handling.m:153` — 🟡 MEDIUM · CONFIRMED
...
#### 156. `limo_tfcluster_test.m:69` — 🟡 MEDIUM · CONFIRMED
...
#### 157. `limo_trimmed_mean.m:113` — 🟡 MEDIUM · CONFIRMED
...
#### 158. `limo_ttest_permute.m:71` — 🟡 MEDIUM · CONFIRMED
...
#### 159. `limo_yuen_ttest.m:70` — 🟡 MEDIUM · CONFIRMED
...
#### 160. `np_spectral_clustering.m:192` — 🟡 MEDIUM · CONFIRMED
...
#### 161. `limo_AIC_BIC.m:84` — ⚪ LOW · CONFIRMED
...
#### 162. `limo_AIC_BIC.m:124` — ⚪ LOW · CONFIRMED
...
#### 163. `limo_check_neighbourghs.m:41` — ⚪ LOW · CONFIRMED
...
#### 164. `limo_check_weight.m:78` — ⚪ LOW · CONFIRMED
...
#### 165. `limo_clusterica.m:82` — ⚪ LOW · CONFIRMED
...
#### 166. `limo_clustering.m:112` — ⚪ LOW · CONFIRMED
...
#### 167. `limo_combine_catvalues.m:40` — ⚪ LOW · CONFIRMED
...
#### 168. `limo_contrast.m:162` — ⚪ LOW · CONFIRMED
...
#### 169. `limo_contrast.m:165` — ⚪ LOW · CONFIRMED
...
#### 170. `limo_contrast.m:595` — ⚪ LOW · CONFIRMED
...
#### 171. `limo_contrast_checking.m:92` — ⚪ LOW · CONFIRMED
...
#### 172. `limo_create_single_trials.m:78` — ⚪ LOW · CONFIRMED
...
#### 173. `limo_create_single_trials.m:189` — ⚪ LOW · CONFIRMED
...
#### 174. `limo_display_image.m:106` — ⚪ LOW · CONFIRMED
...
#### 175. `limo_display_results.m:1975` — ⚪ LOW · CONFIRMED
...
#### 176. `limo_ecluster_make.m:92` — ⚪ LOW · CONFIRMED
...
#### 177. `limo_eeg.m:405` — ⚪ LOW · CONFIRMED
...
#### 178. `limo_eeg.m:722` — ⚪ LOW · CONFIRMED
...
#### 179. `limo_eeg.m:833` — ⚪ LOW · CONFIRMED
...
#### 180. `limo_eeg_tf.m:300` — ⚪ LOW · CONFIRMED
...
#### 181. `limo_expected_chanlocs.m:145` — ⚪ LOW · CONFIRMED
...
#### 182. `limo_glm.m:599` — ⚪ LOW · CONFIRMED
...
#### 183. `limo_glm_boot.m:706` — ⚪ LOW · CONFIRMED
...
#### 184. `limo_glm_handling.m:449` — ⚪ LOW · CONFIRMED
...
#### 185. `limo_gui.m:61` — ⚪ LOW · CONFIRMED
...
#### 186. `limo_ipsi_contra.m:32` — ⚪ LOW · CONFIRMED
...
#### 187. `limo_ipsi_contra.m:88` — ⚪ LOW · CONFIRMED
...
#### 188. `limo_match_frames.m:108` — ⚪ LOW · CONFIRMED
...
#### 189. `limo_max_correction.m:73` — ⚪ LOW · CONFIRMED
...
#### 190. `limo_mglm.m:112` — ⚪ LOW · CONFIRMED
...
#### 191. `limo_mglm.m:267` — ⚪ LOW · CONFIRMED
...
#### 192. `limo_mstat_values.m:120` — ⚪ LOW · CONFIRMED
...
#### 193. `limo_pair_channels.m:47` — ⚪ LOW · CONFIRMED
...
#### 194. `limo_random_effect.m:148` — ⚪ LOW · CONFIRMED
...
#### 195. `limo_random_robust.m:1442` — ⚪ LOW · CONFIRMED
...
#### 196. `limo_random_select.m:318` — ⚪ LOW · CONFIRMED
...
#### 197. `limo_random_select.m:1193` — ⚪ LOW · CONFIRMED
...
#### 198. `limo_rep_anova_old.m:481` — ⚪ LOW · CONFIRMED
...
#### 199. `limo_robust_ci.m:209` — ⚪ LOW · CONFIRMED
...
#### 200. `limo_tfce.m:66` — ⚪ LOW · CONFIRMED
...
#### 201. `limo_tfce.m:638` — ⚪ LOW · CONFIRMED
...
#### 202. `limo_yuen_ttest.m:1` — ⚪ LOW · CONFIRMED
...
#### 203. `limo_FDR.m:15` — ⚪ LOW · PLAUSIBLE
...
#### 204. `limo_batch_design_matrix.m:255` — ⚪ LOW · PLAUSIBLE
...
#### 205. `limo_batch_import_data.m:89` — ⚪ LOW · PLAUSIBLE
...
#### 206. `limo_chancluster_test.m:98` — ⚪ LOW · PLAUSIBLE
...
#### 207. `limo_contrast.m:553` — ⚪ LOW · PLAUSIBLE
...
#### 208. `limo_contrast_checking.m:124` — ⚪ LOW · PLAUSIBLE
...
#### 209. `limo_display_image_callback.m:81` — ⚪ LOW · PLAUSIBLE
...
#### 210. `limo_display_image_callback.m:100` — ⚪ LOW · PLAUSIBLE
...
#### 211. `limo_display_image_tf.m:102` — ⚪ LOW · PLAUSIBLE
...
#### 212. `limo_display_image_tf.m:308` — ⚪ LOW · PLAUSIBLE
...
#### 213. `limo_eeg_tf.m:539` — ⚪ LOW · PLAUSIBLE
...
#### 214. `limo_expected_chanlocs.m:67` — ⚪ LOW · PLAUSIBLE
...
#### 215. `limo_itc_gui.m:655` — ⚪ LOW · PLAUSIBLE
...
#### 216. `limo_median.m:58` — ⚪ LOW · PLAUSIBLE
...
#### 217. `limo_warndlg.m:11` — ⚪ LOW · PLAUSIBLE
...
#### 218. `limo_yuen_ttest.m:143` — ⚪ LOW · PLAUSIBLE
